...
public class Kiloan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Kiloan Laundry List");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    if (dataSnapshot.child("role").getValue().equals("laundry") && dataSnapshot.child("services").getValue() != null && (dataSnapshot.child("services").getValue().equals("Kiloan") ||
                            ...
                            dataSnapshot.child("services").getValue().equals("Satuan; Kiloan") || dataSnapshot.child("services").getValue().equals("Kilat; Pickup; Kiloan") ||
