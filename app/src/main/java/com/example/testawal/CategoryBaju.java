...
public class CategoryBaju extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv.setLayoutManager(new LinearLayoutManager(CategoryBaju.this));
        users = new ArrayList<>();
        myAdapter = new MyAdapter(CategoryBaju.this, users);
    ...
    private void filter(String s) {
        ...
        MyAdapter adapterSearch = new MyAdapter(CategoryBaju.this, searchList);
