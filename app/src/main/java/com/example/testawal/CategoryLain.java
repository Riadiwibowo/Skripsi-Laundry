...
public class CategoryLain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv.setLayoutManager(new LinearLayoutManager(CategoryLain.this));
        users = new ArrayList<>();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    if (dataSnapshot.child("role").getValue().equals("laundry") && dataSnapshot.child("category").getValue() != null &&
                            (dataSnapshot.child("category").getValue().equals("Lain-lain") || dataSnapshot.child("category").getValue().equals("Baju; Lain-lain") ||
    ...
    private void filter(String s) {
        ...
        MyAdapter adapterSearch = new MyAdapter(CategoryLain.this, searchList);
