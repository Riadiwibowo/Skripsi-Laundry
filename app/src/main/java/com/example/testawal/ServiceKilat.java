            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    if (dataSnapshot.child("role").getValue().equals("laundry") && dataSnapshot.child("services").getValue() != null &&
                            (dataSnapshot.child("services").getValue().equals("Kilat") ||
                                    dataSnapshot.child("services").getValue().equals("Kilat; Pickup") || dataSnapshot.child("services").getValue().equals("Kilat; Satuan") ||
                                    dataSnapshot.child("services").getValue().equals("Kilat; Kiloan") || dataSnapshot.child("services").getValue().equals("Kilat; Pickup; Satuan") ||
                                    dataSnapshot.child("services").getValue().equals("Kilat; Pickup; Kiloan") || dataSnapshot.child("services").getValue().equals("Kilat; Satuan; Kiloan") ||
