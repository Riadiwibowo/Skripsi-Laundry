...
public class Pickup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pickup Laundry List");
        ...
        rv.setLayoutManager(new LinearLayoutManager(Pickup.this));
        users = new ArrayList<>();
        myAdapter = new MyAdapter(Pickup.this, users);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    if (dataSnapshot.child("role").getValue().equals("laundry") && dataSnapshot.child("services").getValue() != null &&
                            dataSnapshot.child("services").getValue().toString().contains("Pickup")) {
    ...
    private void filter(String s) {
        ...
        MyAdapter adapterSearch = new MyAdapter(Pickup.this, searchList);
